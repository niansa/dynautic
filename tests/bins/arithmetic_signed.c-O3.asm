...
00000000000e0000 <start_>:
   e0000:	cb000022 	sub	x2, x1, x0
   e0004:	91001c23 	add	x3, x1, #0x7
   e0008:	9ac30c42 	sdiv	x2, x2, x3
   e000c:	9b027c21 	mul	x1, x1, x2
   e0010:	9ac00c22 	sdiv	x2, x1, x0
   e0014:	9b008440 	msub	x0, x2, x0, x1
   e0018:	d65f03c0 	ret
