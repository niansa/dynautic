...
static unsigned short usa[N];
static short sa[N];
static short sb[N];
static short sc[N];
static unsigned int   ua[N];
static int   ia[N] ALIGNED16;
static int   ib[N] ALIGNED16;
static int   ic[N] ALIGNED16;
static unsigned int ub[N];
static unsigned int uc[N];
// static float fa[N], fb[N];
// static float da[N], db[N], dc[N], dd[N];
static int dj[N];
...
static int a[N*2] ALIGNED16;
static int b[N*2] ALIGNED16;
static int c[N*2] ALIGNED16;
static int d[N*2] ALIGNED16;
