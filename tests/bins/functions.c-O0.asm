...
00000000000e0000 <_start>:
   ...
   e0008:	910073e0 	add	x0, sp, #0x1c
   e000c:	94000007 	bl	e0028 <test>
   e0010:	b9401fe0 	ldr	w0, [sp, #28]
...
00000000000e001c <test2>:
   e001c:	52824680 	mov	w0, #0x1234                	// #4660
   e0020:	72b579a0 	movk	w0, #0xabcd, lsl #16
   e0024:	d65f03c0 	ret
...
00000000000e0028 <test>:
   ...
   e0038:	2a0003e1 	mov	w1, w0
   e003c:	f9400fe0 	ldr	x0, [sp, #24]
   e0040:	b9000001 	str	w1, [x0]
   e0044:	d503201f 	nop
