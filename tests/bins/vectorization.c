...
unsigned long _start()
{
  ...
  // BENCH("Example3",   example3(&bfs, N, ia, ib), Mi*2, digest_memory(&bfs.ia[0], &bfs.ia[N]));
  // BENCH("Example4a",  example4a(&bfs, N, ia, ib), Mi*2, digest_memory(&bfs.ia[0], &bfs.ia[N]));
  // BENCH("Example4b",  example4b(&bfs, N-10, ia, ib), Mi*2, digest_memory(&bfs.ia[0], &bfs.ia[N]));
  // BENCH("Example4c",  example4c(&bfs, N, ia, ib), Mi*2, digest_memory(&ibfs.b[0], &bfs.ib[N]));
  ...
  // BENCH("Example10a", example10a(&bfs, sa,sb,sc,ia,ib,ic), Mi*2, digest_memory(&bfs.ia[0], &bfs.ia[N]) + digest_memory(&bfs.sa[0], &bfs.sa[N]));
  // BENCH("Example10b", example10b(&bfs, sa,sb,sc,ia,ib,ic), Mi*4, digest_memory(&bfs.ia[0], &bfs.ia[N]));
  // BENCH("Example11",  example11(&bfs), Mi*2, digest_memory(&bfs.d[0], &bfs.d[N]));
  // BENCH("Example12",  example12(&bfs), Mi*4, digest_memory(&bfs.a[0], &bfs.a[N]));
  // BENCH("Example23",  example23(&bfs, usa,ua), Mi*8, digest_memory(&bfs.usa[0], &bfs.usa[256]));
