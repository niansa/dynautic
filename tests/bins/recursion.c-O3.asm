...
00000000000e0000 <_start>:
   e0000:	52800c81 	mov	w1, #0x64                  	// #100
   e0004:	6b01001f 	cmp	w0, w1
   e0008:	4b000021 	sub	w1, w1, w0
   e000c:	11000400 	add	w0, w0, #0x1
   e0010:	1a9f9021 	csel	w1, w1, wzr, ls	// ls = plast
   e0014:	0b000020 	add	w0, w1, w0
   e0018:	d65f03c0 	ret

Disassembly of section .text:

00000000000e0020 <test>:
   e0020:	b9400002 	ldr	w2, [x0]
   e0024:	52800c81 	mov	w1, #0x64                  	// #100
   e0028:	6b01005f 	cmp	w2, w1
   e002c:	4b020021 	sub	w1, w1, w2
   e0030:	1a9f9021 	csel	w1, w1, wzr, ls	// ls = plast
   e0034:	11000442 	add	w2, w2, #0x1
   e0038:	0b020021 	add	w1, w1, w2
   e003c:	b9000001 	str	w1, [x0]
   e0040:	d65f03c0 	ret
	...
