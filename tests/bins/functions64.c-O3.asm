...
00000000000e0000 <_start>:
   e0000:	d297dde0 	mov	x0, #0xbeef                	// #48879
   e0004:	f2bbd5a0 	movk	x0, #0xdead, lsl #16
   e0008:	f2c24680 	movk	x0, #0x1234, lsl #32
   e000c:	f2f579a0 	movk	x0, #0xabcd, lsl #48
   e0010:	d65f03c0 	ret

Disassembly of section .text:

00000000000e0020 <test2>:
   e0020:	d297dde0 	mov	x0, #0xbeef                	// #48879
   e0024:	f2bbd5a0 	movk	x0, #0xdead, lsl #16
   e0028:	f2c24680 	movk	x0, #0x1234, lsl #32
   e002c:	f2f579a0 	movk	x0, #0xabcd, lsl #48
   e0030:	d65f03c0 	ret

00000000000e0034 <test>:
   e0034:	d297dde1 	mov	x1, #0xbeef                	// #48879
   e0038:	f2bbd5a1 	movk	x1, #0xdead, lsl #16
   e003c:	f2c24681 	movk	x1, #0x1234, lsl #32
   e0040:	f2f579a1 	movk	x1, #0xabcd, lsl #48
   e0044:	f9000001 	str	x1, [x0]
   e0048:	d65f03c0 	ret
   e004c:	00000000 	udf	#0
