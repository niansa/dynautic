...
00000000000e0000 <_start>:
   e0000:	92882200 	mov	x0, #0xffffffffffffbeef    	// #-16657
...
00000000000e0010 <test2>:
   e0010:	5297dde0 	mov	w0, #0xbeef                	// #48879
   e0014:	72bbd5a0 	movk	w0, #0xdead, lsl #16
   e0018:	d65f03c0 	ret
   e001c:	d503201f 	nop

00000000000e0020 <test>:
   e0020:	92882201 	mov	x1, #0xffffffffffffbeef    	// #-16657
   e0024:	f2bbd5a1 	movk	x1, #0xdead, lsl #16
   e0028:	f9000001 	str	x1, [x0]
   e002c:	d65f03c0 	ret
